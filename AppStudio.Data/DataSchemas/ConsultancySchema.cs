...
{
    /// <summary>
    /// Implementation of the ConsultancySchema class.
    /// </summary>
    public class ConsultancySchema : BindableSchemaBase, IEquatable<ConsultancySchema>, ISyncItem<ConsultancySchema>
    {
        ...
        public bool Equals(ConsultancySchema other)
        {
        ...
        public bool NeedSync(ConsultancySchema other)
        {
        ...
        public void Sync(ConsultancySchema other)
        {
        ...
        {
            return Equals(obj as ConsultancySchema);
        }
