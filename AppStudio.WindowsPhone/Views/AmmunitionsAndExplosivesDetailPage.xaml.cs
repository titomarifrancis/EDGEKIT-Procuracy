...
{
    public sealed partial class AmmunitionsAndExplosivesDetail : Page
    {
        private NavigationHelper _navigationHelper;

        private DataTransferManager _dataTransferManager;

        public AmmunitionsAndExplosivesDetail()
        {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (AmmunitionsAndExplosivesModel != null)
            {
                ...
                {
                    AmmunitionsAndExplosivesModel.SelectItem(e.Parameter);
                }

                AmmunitionsAndExplosivesModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
        }
